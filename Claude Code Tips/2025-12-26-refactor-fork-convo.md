...
> When doing a refactor, send in a concise prompt with a markdown file of examples and a target file. After completing the work, fork the convo at the original prompt to do it again (with a different target file).
> 
> New context window each time, simple, targeted, and just works.
>
