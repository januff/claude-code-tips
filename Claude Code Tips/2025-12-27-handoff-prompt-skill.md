...
> To name a few:
> 1. http://Claude.md file for coding standards, from project sizes to git workflows to security standards,etc. 
> 2. Handoff prompt skill
> 3. E2E project documentation to start which I convert into slice prompts + integration contract. Contextual builds and fast
>
